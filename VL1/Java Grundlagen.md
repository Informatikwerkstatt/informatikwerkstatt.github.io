...
</div><ol class="floatleft"><li>Linksclick auf Windows-Symbol</li><li>In Windows-Suche ```cmd``` eingeben (+ Return-Taste)</li><li>Linksclick auf angezeigtes ```cmd```-Symbol</li></ol>
